...
export default function Monetisation({ authContext }) {
  ...
  const verify = async () => {
    ...
    try {
      ...
      setMsg(`✓ Payment verified for ${plan}. TX: ${d.txHash}`);
  ...
  return (
    <>
      ...
      <div className="panel-sub">Unlock LifeHub Pro via Gumroad or pay with crypto.</div>
      ...
      <div className="section-label">Crypto wallets</div>
