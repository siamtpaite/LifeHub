 ...
 * distributed under the License is distributed on an "AS IS" BASIS,
 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 * See the Licenrn this._getIdTokenResponse(auth);
    };
...
var OAuthProvider = /** @class */ (function (_super) {
     ...
     *
     * @remarks
     * The raw nonce is required when an ID token with a ny = (_a = searchParams["apiKey" /* QueryField.API_KEY */]) !== null && _a !== void 0 ? _a : null;
        var code = (_b = searchParams["oobCode" /* QueryField.CODE */]) !== null && _b !== void 0 ? _b : null;
        var operation = parseMode((_c = searchParams["mode" /* QueryField.MODE */]) !== null && _c !== void 0 ? _c : null);
        // Validate API key, code and mode.
        _assert(apiKey && code && operation, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
...
var EmailAuthProvider = /** @class */ (function () {
     ...
     * Always set to {@link ProviderId}.PASSWORD, even for email link.
     */
    EmailAuthProvisigned-in user info.
 * const user = result.user;
...
var GithubAuthProvider = /** @class */ (function (_super) {
    ...
    GithubAuthProvider.GITHUB_SIGN_IN_METHOD = "gitsigned-in user info.
 * const user = result.user;
 * // This gives you a Facebook Access Token.
 * const credential = FacebookAuthProvider.credentialFromResult(result);
 * const token = credential.accessToken;
...
var TwitterAuthProvider = /** @class */ (function (_super) {
    ...
    /**
     * Used to extract the underlying {@ * Takes a set of UserInfo provider data and converts it to a set of names
 */
...
/**
 * @licen * Takes a set of UserInfo provider data and converts it to a set of names
 */
function providerDataAsNames(providerData) {
    return new Set(providerData
        .map(function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            data: {
                                email: (response.requestType === "VERIFY_AND_CHANGE_EMAIL" /* ActionCodeOperation.V
        }
        else if ('totpInfo' in enrollment) {
            return TotpMultiFactorInfoImpl._fromServerResponse(auth, enrollment);
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authInternal = _castAuth(auth);
                    if (!authInternal._getPasswordPolicyInternal()) return [3 /*break*/, 2];
                    return [4 /*yield*/, authInss the user's email account. The
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userInternal = getModularInstance(user);
                    return [4 /*yielss the user's email account. The
 * email address serves as a unique identifier for the user, and the password is used to access
 * the user's account in your Firebase project. See also: {@link createUserWithEmailAndPassword}.
 *
 *
 ...
 */
/**
 * Sends a sign-in email link to the user witnewEmail - The new email address to be verified before update.
 * @param actionCodeSettings - The {@link ActionCodeSettings}.
 *
 * @public
 */
...
var GenericAdditionalUserInfo = /** @class */ (function () {
    function GenericAdditionalUserInfo(isNewUser, providerId, profile) {
        ...
        this.providerId = providerId - The new email address to be verified before update.
 * @param actionCodeSettings - The {@link ActionCodeSettings}.
 *
 * @public
 */
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    response = _b.sent();
                    userInternal.displayName = response.displayName || null;
                    userInternal.photoURL verification flow should be triggered for each auth provider, into the
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*ation flow should be triggered for each auth provider, into the
 * current Auth session.
 *
 * If initializeRecaptchaConfig() is not invoked, the auth flow will always start
 * without reCAPTCHA verification. If the provider is configured to require reCAPTCHA
...
function registerAuth(clientPlatform) {
    ...
    _registerComponent(new Component("auth-internal" /* _ComponentName.AUTH_INTERNAL */, pply(_a, [_c.sent(), this.user])];
                }
            });
        });
    };
...
var BrowserSessionPersistence = /** @class */ (function (_super) {
    ...
    BrowserSessionPersistence.prototype._removeListener = function (_key, _listener) {
        // Listeners are not supported for session storage since it cannot be sha  catch (_a) {
            return Promise.resolve(false);
        }
    };
    BrowserPersistenceClass.prototype._set = function (key, value) {
...
var BrowserLocalPersistence = /** @class */ (function (_super) {
    ...
    BrowserLocalPersistence.prototype.onStorageEvent = function (event, poll) {
        ...
        vare the License for the specific language governing permissions and
 * limitations under the License.
 */
/**
 ...
 * Unless required by applicable law or agreed to in writing, software
 * distributed under the License is distributed on an "AS IS" BASIS,
 * WITHOUT WARRANTIES OR CONDITIONS OF ANif (typeof closeBrowserTab === 'function') {
                                    closeBrowserTab();
                                }
